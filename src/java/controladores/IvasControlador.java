...
public class IvasControlador {
    public static boolean agregar(Ivas iva){
        ...
        if (Conexion.conectar()){
            String sql = "insert into ivas (nombre_iva, porcentaje_iva)" 
                    + "values ('" +iva.getNombre_iva() + "','"
                    + iva.getPorcentaje_iva() + "')";
    ...
    public static boolean modificar(Ivas iva){
        boolean valor = false;
        if (Conexion.conectar()){ 
            String sql = "update ivas set nombre_iva='" + iva.getNombre_iva() + "', "
                    + "porcentaje_iva='" + iva.getPorcentaje_iva() + "'"
    ...
    public static String buscarNombre(String nombre, int pagina) {
        ...
        if (Conexion.conectar()) {
            ...
            try {
                ...
                String sql = "select * from ivas where (nombre_iva) like '%" +
                        nombre + "%'"
